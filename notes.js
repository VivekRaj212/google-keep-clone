...
const addNotes=()=> {
    ...
    function displayNotes(){
        ...
        for(let i=0; i<notes.length; i++)
        {
                ...
                <button class="deleteNote" id=${i} onclick="deleteNote(${i})" ><img src="icons8-delete-80.png"></button>
                </div>
                `;        
        }
...
function archiveNote(ind){
    ...
    function showArchiveNotes(){  
        ...
        for(let i=0; i<archiveNotes.length; i++){
            archiveNotesHTML += `<div class="note">
                            ...
                            <button class="deleteNote" id=${i} onclick="deleteArchiveNotes(${i})"><img src="icons8-delete-80.png"></button>
    ...
    const displayDeletedNotes =()=> {
        ...
        for(let i=0; i<deletedNotes.length; i++)
        {
                ...
                <button class="deleteNote" id=${i} onclick="deleteBinNotes(${i})" ><img src="icons8-delete-80.png"></button>
                </div>
                `;        
        }
